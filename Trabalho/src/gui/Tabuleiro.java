...
public class Tabuleiro extends JPanel {
	...
	public Tabuleiro() {
		...
		casas[1]=new Terreno(15,800,1,1,220); //t curicica
		casas[2]=new Casa(15,695,3,2,0);
		casas[3]=new Empresa(15,600,2,3,200);
		casas[4]=new Terreno(15,505,1,4,300); //t leme
		casas[5]=new Terreno(15,410,1,5,220);
		casas[6]=new Casa(15,320,3,6,0);
		casas[7]=new Empresa(15,230,2,7,150);
		casas[8]=new Terreno(15,140,1,8,140);
		casas[9]=new Casa(15,30,7,9,0); //prisao
		casas[10]=new Terreno(130,10,1,10,60);
		casas[11]=new Terreno(223,10,1,11,180);
		casas[12]=new Terreno(316,10,1,12,300);
		casas[13]=new Casa(409,10,3,13,0);
		casas[14]=new Terreno(502,10,1,14,260);
		casas[15]=new Empresa(595,10,2,15,200);
		casas[16]=new Terreno(688,10,1,16,220);
		...
		casas[20]=new Terreno(870,225,1,20,180);
		casas[21]=new Terreno(870,318,1,21,140);
		casas[22]=new Terreno(870,411,1,22,120);
		casas[23]=new Casa(870,504,3,23,0);
		casas[24]=new Empresa(870,597,2,24,200);
		casas[25]=new Terreno(870,690,1,25,60);
		casas[26]=new Terreno(870,783,1,26,260);
		casas[27]=new Casa(880,870,6,27,0); //casa va para prisao
		casas[28]=new Terreno(780,875,1,28,160);
		casas[29]=new Casa(687,875,3,29,0);
		casas[30]=new Terreno(594,875,1,30,240);
		casas[31]=new Empresa(501,875,2,31,150);
		casas[32]=new Terreno(408,875,1,32,100);
		casas[33]=new Casa(315,875,3,33,0);
		casas[34]=new Casa(222,875,4,34,200); //casa de evento pague x
		casas[35]=new Terreno(129,875,1,35,100);
